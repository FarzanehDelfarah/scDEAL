...
def run_main(args):
    ...
    data_r = pd.read_csv('data/ALL_gene_expression.csv', index_col=0)  # Bulk data
    label_r = pd.read_csv('data/ALL_label_binary.csv', index_col=0)  # Labels
...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('--bulk_data', type=str, required=True, default='data/ALL_gene_expression.csv', help='Path of the bulk RNA-Seq expression profile')
    parser.add_argument('--label', type=str, required=True, default='data/ALL_label_binary.csv', help='Path of the processed bulk RNA-Seq drug screening annotation')
    ...
    parser.add_argument('--selected_dose', type=str, required=True, default="DOSE2", help='Name of the selected dose, should be a column name in the input file of --label')
    ...
    parser.add_argument('--bulk_model_path', type=str, default='save/models/', help='Path of the trained predictor in the bulk level')
